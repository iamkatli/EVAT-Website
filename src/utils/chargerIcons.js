...
export const icons = {
  ...
  white: new L.Icon({ iconUrl: chargerWhite,  iconSize: [32, 32], iconAnchor: [16, 32] })
};

export function iconForReliability(showReliability, reliability, isDark) {
  if (!showReliability) return isDark ? icons.white : icons.black;
  if (typeof reliability !== 'number') return isDark ? icons.white : icons.black;
